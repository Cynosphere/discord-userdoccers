...
| with_games?               | boolean   | Whether the invite's guild profile should include game objects (default false)                                            |
...
<RouteHeader method="GET" url="/invites/{invite.code}/target-users" supportsBot>
...
<RouteHeader method="PUT" url="/invites/{invite.code}/target-users" supportsBot>
...
<RouteHeader method="GET" url="/invites/{invite.code}/target-users/job-status" supportsBot>
