...
| third_party_skus?       | array[[application SKU](#application-sku-object) object]           | The third party SKUs of the game                                   |
| first_release_date?     | ?ISO8601 timestamp                                                 | When the game was first released                                   |
...
| media?                  | [game media](#game-media-structure) object                         | Icon, cover image, and artwork of the game                         |
| content_classification? | [content classification](#content-classification-structure) object | Classifications for content in the game, such as age ratings       |
...
###### Game Media Structure

| Field         | Type                                                          | Description                        |
| ------------- | ------------------------------------------------------------- | ---------------------------------- |
| cover_url?    | string                                                        | URL to the cover image             |
| artwork_urls? | array[string]                                                 | URLs to artwork images             |
| icon?         | [game media value](#game-media-value-structure) object        | Value representing the icon        |
| cover?        | [game media value](#game-media-value-structure) object        | Value representing the cover image |
| artwork?      | array[[game media value](#game-media-value-structure) object] | Values representing artwork images |

###### Game Media Value Structure

| Field | Type   | Description                                          |
| ----- | ------ | ---------------------------------------------------- |
| type  | string | Either `url` or `hash`                               |
| value | string | A URL when `type` is `url` or a hash to a CDN object |

###### Content Classification Structure

| Field          | Type                                               | Description                            |
| -------------- | -------------------------------------------------- | -------------------------------------- |
| agency_ratings | [agency ratings](#agency-ratings-structure) object | Game age ratings from various agencies |

###### Agency Ratings Structure

| Field | Type                                                         | Description                       |
| ----- | ------------------------------------------------------------ | --------------------------------- |
| esrb  | [ESRB rating](/resources/store#content-rating-agency) object | Game content rating from the ESRB |
| pegi  | [PEGI rating](/resources/store#content-rating-agency) object | Game content rating from PEGI     |
